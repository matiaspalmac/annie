...
const CONFIG = {
  ...
  MENSAJE_ROLES_ID: "1469873171426447594",
...
const CLIMA_PUEBLO = {
  hoy: {
    ...
    descripcion:
      "¡Feliz viernes, vecino! El cielo se ha despejado por completo y el sol brilla con fuerza. Es un día maravilloso para salir a recolectar conchas a la orilla del mar o regar las flores. ¡No olvides disfrutar de este clima tan radiante! ☀️🌻 ",
      eventos: [
    ...
    { dia: "Viernes", icono: "🌧️", clima: "Lluvia ligera" },
  ],
};
