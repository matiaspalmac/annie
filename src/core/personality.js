...
const FRASES = {
  peces: [
    ...
    "Me han contado que en el Lago del Eco hay peces que solo aparecen cuando la luna esta llena. Que magico.",
  ...
  animales: [
    ...
    "La senora Joan me conto que cada animalito tiene una comida favorita secreta. Vale la pena descubrirla.",
  ...
  cultivos: [
    ...
    "Los hibridos de temporada son mis favoritos. Cada estacion trae su propia sorpresa.",
  ...
  recetas: [
    ...
    "Un buen desayuno cambia el humor del dia entero. Massimo lo sabe mejor que nadie.",
  ],
  logros: [
    ...
    "Cada logro que consigues es una historia nueva que agregar a tu vida en la Aldea.",
    "No te compares con nadie, corazon. Cada quien avanza a su ritmo y eso esta perfecto.",
  ...
  recolectables: [
    ...
    "Las ramitas no parecen mucho, pero con suficientes puedes construir cosas muy lindas.",
    ...
    "Recolectar es como una caza del tesoro que nunca termina. Siempre hay algo nuevo.",
  ],
  habitantes: [
    ...
    "Cada habitante tiene una historia que vale la pena conocer. Vale la pena charlar.",
  ],
  codigos: [
  ...
  mineria: [
    ...
    "Si llevas buena herramienta, la roca se rinde mas rapido. Bob conoce a alguien que las afila.",
  ...
  fotografia: [
    ...
    "El pueblo tiene rincones fotogenicos que ni los mismos vecinos conocen. Vale explorar.",
    ...
    "Una foto borrosa de algo hermoso vale mas que una foto perfecta de algo aburrido.",
  ],
  general: [
    ...
    "La Aldea Luciernaga es un lugar magico... y tu lo haces aun mas especial estando aqui.",
    "A veces lo mejor que puedes hacer es salir a caminar por el pueblo sin rumbo fijo, po.",
    "Cada dia en la Aldea es diferente. Eso es lo que lo hace tan especial.",
...
const SUGERENCIAS = {
  peces: [
    ...
    "Vanya tiene informacion valiosa sobre cada especie. Dale una visita. (`/habitantes`)",
  ...
  insectos: [
    ...
    "Las redes de mejor calidad hacen mas facil la caza. Preguntale a Naniwa. (`/habitantes`)",
  ...
  animales: [
    ...
    "Cada animalito tiene una comida favorita. Descubrirla es parte de la aventura. (`/animales`)",
  ...
  cultivos: [
    ...
    "Las semillas hibridas dan frutos mas valiosos. Preguntale a Blanc. (`/habitantes`)",
  ...
  recetas: [
    ...
    "Las recetas de temporada usan ingredientes especificos de cada estacion. (`/recetas`)",
  ...
  logros: [
    ...
    "Algunos logros requieren completar otras cosas primero. Revisa bien los requisitos. (`/logros`)",
  ],
  recolectables: [
  ...
  habitantes: [
    ...
    "Algunos habitantes desbloquean **recetas** especiales. (`/recetas`)",
    ...
    "Algunos NPCs tienen tiendas que cambian segun el clima. (`/habitantes`)",
  ],
  codigos: [
  ...
  mineria: [
    ...
    "En las cuevas tambien puedes encontrar **recolectables** sorpresa. (`/recolectables`)",
  ...
  fotografia: [
    ...
    "Los **logros de fotografia** tienen titulos muy originales. (`/logros`)",
...
export const FRASES_AMBIENT = [
  ...
  "Hoy se me antoja una sopaipilla con mostaza. Ustedes no.",
  ...
  "Las mariposas andaban locas hoy por el campo. Que dia tan bonito.",
  ...
  "Que bonito que la Aldea tenga un pueblito tan lindo... y vecinitos tan especiales.",
